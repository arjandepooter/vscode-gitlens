...
## [Unreleased]
### Changed
- Changes annotation hovers to only add `Open in Remote` and `Show Commit Details` -- thanks to [PR #158](https://github.com/eamodio/vscode-gitlens/pull/158) by SpaceEEC ([@SpaceEEC](https://github.com/SpaceEEC))!
...
- Fixes issue when checking for any remotes could return no remotes even if remotes are configured
